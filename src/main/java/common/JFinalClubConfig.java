...
import common.entity._MappingKit;
import common.shiro.ShiroInterceptor;
import common.shiro.ShiroPlugin;
import common.shiro.shiroTagForHasRole;
...
public class JFinalClubConfig extends JFinalConfig {
	private Routes routes = new FrontRoutes();
    ...
    public void configEngine(Engine me) {
    	...
    	//me.addSharedFunction("/WEB-INF/views/common/_layout.html");
		//me.addSharedFunction("/WEB-INF/views/common/_menu.html");
